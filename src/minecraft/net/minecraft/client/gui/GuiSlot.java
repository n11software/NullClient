...
public abstract class GuiSlot
{
    ...
    public void drawScreenNoDirt(int mouseXIn, int mouseYIn, float p_148128_3_) {
        if (this.field_178041_q) {
            this.mouseX = mouseXIn;
            this.mouseY = mouseYIn;
            ...
            // Top fade
            worldrenderer.pos(this.left, this.top, 0.0D).color(0, 0, 0, 255).endVertex();
            worldrenderer.pos(this.right, this.top, 0.0D).color(0, 0, 0, 255).endVertex();
            worldrenderer.pos(this.right, this.top + i1, 0.0D).color(0, 0, 0, 0).endVertex();
            worldrenderer.pos(this.left, this.top + i1, 0.0D).color(0, 0, 0, 0).endVertex();
            tessellator.draw();

            // Bottom fade
            worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
            worldrenderer.pos(this.left, this.bottom - i1, 0.0D).color(0, 0, 0, 0).endVertex();
            worldrenderer.pos(this.right, this.bottom - i1, 0.0D).color(0, 0, 0, 0).endVertex();
            worldrenderer.pos(this.right, this.bottom, 0.0D).color(0, 0, 0, 255).endVertex();
            worldrenderer.pos(this.left, this.bottom, 0.0D).color(0, 0, 0, 255).endVertex();
            tessellator.draw();
            ...
            if (j1 > 0)
            {
                ...
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                worldrenderer.pos((double)i, (double)this.bottom, 0.0D).tex(0.0D, 1.0D).color(0, 0, 0, 0).endVertex();
                worldrenderer.pos((double)j, (double)this.bottom, 0.0D).tex(1.0D, 1.0D).color(0, 0, 0, 0).endVertex();
                worldrenderer.pos((double)j, (double)this.top, 0.0D).tex(1.0D, 0.0D).color(0, 0, 0, 0).endVertex();
                worldrenderer.pos((double)i, (double)this.top, 0.0D).tex(0.0D, 0.0D).color(0, 0, 0, 0).endVertex();
                tessellator.draw();
                worldrenderer.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
                worldrenderer.pos((double)i, (double)(l1 + k1), 0.0D).tex(0.0D, 1.0D).color(128, 128, 128, 255).endVertex();
                worldrenderer.pos((double)j, (double)(l1 + k1), 0.0D).tex(1.0D, 1.0D).color(128, 128, 128, 255).endVertex();
