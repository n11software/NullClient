...
public class WindowedFullscreenSettings {
    public ModWindowedFullscreen theMod;
    public File configFile;
    public boolean enabled = false;

    Gson gson = new Gson();

    public WindowedFullscreenSettings(ModWindowedFullscreen mod, File directory) {
        if (!directory.exists()) directory.mkdirs();
        theMod = mod;
        configFile = new File(directory, "fullscreen.json");
        this.load();
    }
