...
public class PingSettings {
    public ModPing theMod;
    public File configFile;
    public RelativePosition pos = new RelativePosition(0, 5, 16);
    ...
    public PingSettings(ModPing mod, File directory) {
        if (!directory.exists()) directory.mkdirs();
        theMod = mod;
        configFile = new File(directory, "ping.json");
        this.load();
    }
